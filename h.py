...
'''
Чтобы получить токен вам нужно зайти в телеграмм и написать боту под названием @BotFather
Вводите команду /start далее прописываете команду /newbot
Далее пройдете небольшую регистрацию бота и он выдаст вам токен, его уже можно вставить в переменную ниже
'''
token = 'Ваш Токен'
